...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::evaluate_user_security_indicators,
            commands::evaluate_user_security_indicators_batch,
            commands::evaluate_computer_security_indicators,
            commands::evaluate_computer_security_indicators_batch,
